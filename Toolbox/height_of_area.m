...
% p = scatter3(ax,Obj.highResDat.Xf,Obj.highResDat.Yf,Obj.highResDat.Zf);
...
pcInt = scatteredInterpolant([Obj.highResDat.Xf,Obj.highResDat.Yf]./1E3,Obj.highResDat.Zf,'linear','none');

elDist = -100:0.5:100;
elAngle =  258.4627826086956;
dhmTree = [6.93422e+02 6.175546e+03]*1E3;
[~,a]=max(Obj.highResDat.Zf);
 pcTree = [Obj.highResDat.Xf(a) Obj.highResDat.Yf(a)]/1E3;
